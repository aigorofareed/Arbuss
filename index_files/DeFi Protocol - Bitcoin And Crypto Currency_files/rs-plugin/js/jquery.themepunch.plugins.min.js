            ...
            <ul>
                ...
                <li data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-delay="10000" data-saveperformance="off" data-title="Slide One">
                    ...
                    <div class="tp-caption lfb ltt tp-resizeme rs-parallaxlevel-10" data-x="left" data-hoffset="0" data-y="center" data-voffset="65" data-speed="1400" data-start="1400" data-endspeed="1200" data-easing="easeOutExpo" data-splitin="none" data-splitout="none"
                        data-elementdelay="0.01" data-endelementdelay="0.1">
                        <a href="wallets/" class="btn-style btn-filled">Read More</a> &ensp;&ensp;
                        <a href="wallets/" class="btn-style btn-border">Resolve</a>
                    </div>
                </li>
                <!-- SLIDE 2 -->
                <li data-transition="slidedown" data-slotamount="1" data-masterspeed="1000" data-delay="10000" data-saveperformance="off" data-title="Slide Two">
                    ...
                    <div class="tp-caption lfb ltt tp-resizeme rs-parallaxlevel-10" data-x="left" data-hoffset="0" data-y="center" data-voffset="65" data-speed="1400" data-start="1400" data-endspeed="1200" data-easing="easeOutExpo" data-splitin="none" data-splitout="none"
                        data-elementdelay="0.01" data-endelementdelay="0.1">
                        <a href="#" class="btn-style btn-border">Learn More</a> &ensp;&ensp;
                        <a href="#" class="btn-style btn-filled">Resolve</a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <div class="section-title">
                        <h3>DeFi Protocol <span>Authentication</span></h3>
                        <p>DeFi Protocol is a decentralized platform and network that blends Blockchain with DeFi, incorporating Blockchain aspects such as non-custodial management, Micropools, rapid liquidity, and decentralized governance. Each procedure
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-3 col-12 mb-lg-0 mb-md-0 mb-5">
                    <div class="single-address">
                        <div class="single-address-icon">
                            <img src="/migration1.png" style="width: 150px">
                        </div>
                        <div class="single-address-dec">
                            <h4>Migration</h4>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-12 mb-lg-0 mb-md-0 mb-5">
                    <div class="single-address">
                        <div class="single-address-icon">
                            <img src="/dollar_bag.png" style="width: 150px">
                        </div>
                        <div class="single-address-dec">
                            <h4>Claim Token</h4>
                        </div>
